	...
	for (int i = 0; i < numCases; i++)
	{
		...
		for (int j = 0; j < numL; j++)
		{
			...
			if (it != diccionario.end())
			{
				...
				if ((elem.numPos == 1 && elem.pos[0] != 2) || (elem.numPos == 2 && elem.pos[0] != 0 && elem.pos[1] != 0))
				{
					elem.pos[elem.numPos] = 0;
					elem.numPos++;
					it.setVal(elem);
				}
			}
		...
		for (int j = 0; j < numR; j++)
		{
			...
			{
				chocolate elem = it.valor();
				if ((elem.numPos == 1 && elem.pos[0] != 1) || (elem.numPos == 2 && elem.pos[0] != 1 && elem.pos[1] != 1))
				{
					elem.pos[elem.numPos] = 1;
					elem.numPos++;
					it.setVal(elem);
				}
			}
		...
		for (int j = 0; j < numS; j++)
		{
			...
			{
				chocolate elem = it.valor();
				if ((elem.numPos == 1 && elem.pos[0] != 2) || (elem.numPos == 2 && elem.pos[0] != 2 && elem.pos[1] != 2))
				{
					elem.pos[elem.numPos] = 2;
					elem.numPos++;
					it.setVal(elem);
				}
			}
